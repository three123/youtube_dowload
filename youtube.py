...
#下载1080p视频
COMMAND_PREFIX_DOWNLOAD = 'yt-dlp -o "{}%(title)s.%(ext)s" -f 137+140 --write-auto-sub --sub-langs=zh-Hans,en '.format(DOWNLOAD_PATH)
#COMMAND_PREFIX_DOWNLOAD = 'yt-dlp -f 137+140 --write-auto-sub '

#获取视频标题
COMMAND_PREFIX_TITLE = 'yt-dlp -e --get-title '

#转换SRT
COMMAND_PREFIX_SRT = 'ffmpeg -i "{}%(title)s.en.vtt" "{}%(title)s.en.srt" '
...
def vtt_to_srt(url):
    ...
    cover_url = COVER_URL.format(id)
    cover_name = subprocess.getstatusoutput(COMMAND_PREFIX_TITLE + url)[1]
    COMMAND_PREFIX_SRT1 = 'ffmpeg -i "download\\' + cover_name + '.en.vtt" "download\\' + cover_name + '.en.srt" '
    COMMAND_PREFIX_SRT2 = 'ffmpeg -i "download\\' + cover_name + '.zh-Hans.vtt" "download\\' + cover_name + '.zh-Hans.srt" '
    print("\n en :  " + COMMAND_PREFIX_SRT1 + "\n en :  " + COMMAND_PREFIX_SRT2 )
    c2 = subprocess.getstatusoutput(COMMAND_PREFIX_SRT1)
    c2 = subprocess.getstatusoutput(COMMAND_PREFIX_SRT2)
